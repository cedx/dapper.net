...
Task("build")
	...
	.Does(() => DotNetBuild("Dapper.slnx", new() { Configuration = release ? "Release" : "Debug" }));
...
Task("publish")
	...
	.Does(() => DotNetPack("Dapper.slnx", new() { OutputDirectory = "var" }))
...
Task("test")
	...
	.Does(() => DotNetTest("Dapper.slnx", new() { Settings = ".runsettings" }));
